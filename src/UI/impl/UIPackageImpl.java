...
public class UIPackageImpl extends EPackageImpl implements UIPackage {
	 ...
	 * @generated
	 */
	public EReference getElement_Layout() {
	 ...
	 * @generated
	 */
	public EAttribute getLayout_Left() {
	 ...
	 * @generated
	 */
	public EAttribute getLayout_Right() {
	 ...
	 * @generated
	 */
	public EAttribute getInputBox_Capacity() {
	...
	public void createPackageContents() {
		...
		createEReference(elementEClass, ELEMENT__LAYOUT);
		...
		createEAttribute(layoutEClass, LAYOUT__LEFT);
		createEAttribute(layoutEClass, LAYOUT__RIGHT);
		...
		createEAttribute(inputBoxEClass, INPUT_BOX__CAPACITY);
	...
	public void initializePackageContents() {
		...
		inputBoxEClass.getESuperTypes().add(this.getWidget());
		buttonEClass.getESuperTypes().add(this.getWidget());

		// Initialize classes, features, and operations; add parameters
		initEClass(elementEClass, Element.class, "Element", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getElement_Layout(), this.getLayout(), this.getLayout_Elements(), "layout", null, 0, 1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getElement_PosX(), ecorePackage.getEInt(), "posX", null, 0, 1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getElement_PosY(), ecorePackage.getEInt(), "posY", null, 0, 1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLayout_Elements(), this.getElement(), this.getElement_Layout(), "elements", null, 0, -1, Layout.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getLayout_Left(), ecorePackage.getEBoolean(), "left", null, 0, 1, Layout.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLayout_Right(), ecorePackage.getEBoolean(), "right", null, 0, 1, Layout.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getInputBox_Capacity(), ecorePackage.getEInt(), "capacity", null, 0, 1, InputBox.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
